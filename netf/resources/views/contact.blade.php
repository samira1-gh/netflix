...
@section('content')
    ...
    <!-- breadcrumb -->
    <div class="gen-breadcrumb" style="background-image: url('images/asset-20.jpg');">
        <div class="container">
                ...
                <div class="col-xl-4 col-md-12 mt-4 mt-xl-0">
                    <div class="gen-icon-box-style-1">
                        ...
                        <div class="gen-icon-box-content">
                            ...
                            <p class="gen-icon-box-description"><a href="http://gentechtree.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="cca5a2aaa38caba9a2b8a9afa4b8bea9a9e2afa3a1">[email&#160;]</a><br><a href="http://gentechtree.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="6b02050d04592b0c0e051f0e08031f190e0e45080406">[email&#160;]</a></p>
                        </div>
                    </div>
                </div>
            </div>
